<x-app-layout>
    ...
    <div class="flex item-center grid grid-cols-4 gap-5 mt-4 m-2 p-2">
        <div class="col-span-3">
            <div
                class="shadow-md mt-4 relative mx-auto w-full overflow-hidden rounded-md bg-gray-100 p-2 sm:p-4 h-auto">
        ...
        <div>
            <div class="shadow-md mt-4 relative mx-auto max-w-2xl overflow-hidden rounded-md bg-gray-100 p-2 sm:p-4">
                ...
                <ul role="list" class="divide-y divide-gray-100 overflow-y-scroll max-h-screen h-96">
                    ...
                    <li
                        class="flex justify-between gap-x-6 py-5 shadow-md hover:shadow-2xl hover:duration-700 bg-gray-100 p-4 mt-4">
                        <div onclick="updateUser({{ $user->id }})" class="flex min-w-0 gap-x-4">
                            <img class="h-12 w-12 flex-none rounded-full ring-4 {{$user->status=='inactive'?'ring-red-500':'ring-blue-500'}} bg-gray-50"
