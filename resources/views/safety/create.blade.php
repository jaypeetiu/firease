<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-md shadow">
        <h2 class="text-2xl font-bold mb-4">Safety Tips</h2>
        ...
        <form action="{{ route('safety.store') }}" method="POST">
            ...
            <div class="mb-4">
                <label for="shortdescription" class="block text-sm font-medium text-gray-600">Short Description</label>
                <textarea name="shortdescription" id="shortdescription" rows="4"
            ...
            <div class="mb-4">
                <button type="submit" class="bg-red-500 text-white px-4 py-2 rounded">Publish</button>
            </div>
        </form>
    </div>
